...
export default function Page() {
	...
	async function addNewProduct(event: any): void {
		...
		try {
			const fetchURL: string = concatURL("/api/admin/products/new");
		...
		<Fragment>
			...
			<section className="py-10">
				<div className="container">
					<form onSubmit={addNewProduct} className="max-w-[700px]">
...
// 	const [integer, setInteger] = useState(value.split(0) || "");
// 	const [decimal, setDecimal] = useState(value.split(1) || "");

// 	useEffect(() => {
// 		if(typeof onChange === "function") {
// 			onChange({ value: `${integer}.${decimal}` })
// 		}
// 	}, [integer, decimal])

// 	function validateInput(event: any, type): void {
// 		if(event.key !== "Backspace" && event.key !== "Tab") {
// 			if(!/\d/.test(event.key)) {
// 				return event.preventDefault();
// 			}

// 			if(type === "decimal" && inputValue.decimal.length === 2) {
// 				return event.preventDefault();
// 			}
// 		}
// 	}
...
// 				<input
// 					type="text"
// 					value={new Intl.NumberFormat().format(integer)}
// 					onChange={({target: {value}}) => setInteger(value)}
// 					onKeyDown={(event) => validateInput(event, "integer")}
// 					className="p-2 border rounded border-gray-300 block w-full"
// 				/>
// 			</div>
...
// 					type="text"
// 					value={decimal}
// 					onChange={({target: {value}}) => setDecimal(value)}
// 					onKeyDown={(event) => validateInput(event, "decimal")}
// 					className="p-2 border rounded border-gray-300 block w-full"
// 				/>
// 			</div>*/}
// 		</div>
